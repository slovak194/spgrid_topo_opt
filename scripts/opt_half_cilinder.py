...
opt.add_dirichlet_bc((0, 0.0654, 0.3345/2), radius=0.02, axis='xyz', value=(0, 0, 0))
# opt.add_dirichlet_bc((0, 0.1, 0.0), radius=0.01, axis='xyz', value=(0, 0, 0))
# opt.add_dirichlet_bc((0, 0.1, -0.1), radius=0.01, axis='xyz', value=(0, 0, 0))
# opt.add_dirichlet_bc((0, 0.1,  0.1), radius=0.01, axis='xyz', value=(0, 0, 0))
opt.add_dirichlet_bc((0, 0.0654, -0.3345), radius=0.02, axis='xyz', value=(0, 0, 0))
opt.add_dirichlet_bc((0, 0.0654,  0.3345), radius=0.02, axis='xyz', value=(0, 0, 0))
# opt.add_dirichlet_bc((0, 0.1, -0.3), radius=0.01, axis='xyz', value=(0, 0, 0))
# opt.add_dirichlet_bc((0, 0.1,  0.3), radius=0.01, axis='xyz', value=(0, 0, 0))

# opt.add_dirichlet_bc((0, 0.1,  0.2), radius=0.01, axis='xyz', value=(0, 0, 0))

opt.general_action(action='add_mesh_normal_force', mesh_fn=obj_file_path, magnitude=-1, center=(0.21, 0.26, 0), falloff=3000, maximum_distance=0.005)
